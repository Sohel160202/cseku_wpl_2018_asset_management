...
(3769, 'COURSE_C', 'COURSE_C', 'COURSE'),
(3770, 'COURSE_R', 'COURSE_R', 'COURSE'),
(3771, 'COURSE_U', 'COURSE_U', 'COURSE'),
(3772, 'COURSE_D', 'COURSE_D', 'COURSE'),
(3773, 'COURSE_TYPE_C', 'COURSE_TYPE_C', 'COURSE TYPE'),
(3774, 'COURSE_TYPE_R', 'COURSE_TYPE_R', 'COURSE TYPE'),
(3775, 'COURSE_TYPE_U', 'COURSE_TYPE_U', 'COURSE TYPE'),
(3776, 'COURSE_TYPE_D', 'COURSE_TYPE_D', 'COURSE TYPE'),
(3777, 'COURSE_SESSIONAL_TYPE_C', 'COURSE_SESSIONAL_TYPE_C', 'COURSE SESSIONAL TYPE'),
(3778, 'COURSE_SESSIONAL_TYPE_R', 'COURSE_SESSIONAL_TYPE_R', 'COURSE SESSIONAL TYPE'),
(3779, 'COURSE_SESSIONAL_TYPE_U', 'COURSE_SESSIONAL_TYPE_U', 'COURSE SESSIONAL TYPE'),
(3780, 'COURSE_SESSIONAL_TYPE_D', 'COURSE_SESSIONAL_TYPE_D', 'COURSE SESSIONAL TYPE'),
(3781, 'CLUB_C', 'CLUB_C', 'CLUB'),
(3782, 'CLUB_R', 'CLUB_R', 'CLUB'),
(3783, 'CLUB_U', 'CLUB_U', 'CLUB'),
(3784, 'CLUB_D', 'CLUB_D', 'CLUB'),
(3785, 'DISCUSSION_C', 'DISCUSSION_C', 'DISCUSSION'),
(3786, 'DISCUSSION_R', 'DISCUSSION_R', 'DISCUSSION'),
(3787, 'DISCUSSION_U', 'DISCUSSION_U', 'DISCUSSION'),
(3788, 'DISCUSSION_D', 'DISCUSSION_D', 'DISCUSSION'),
(3789, 'DISCUSSION_CAT_C', 'DISCUSSION_CAT_C', 'DISCUSSION CATEGORY'),
(3790, 'DISCUSSION_CAT_R', 'DISCUSSION_CAT_R', 'DISCUSSION CATEGORY'),
(3791, 'DISCUSSION_CAT_U', 'DISCUSSION_CAT_U', 'DISCUSSION CATEGORY'),
(3792, 'DISCUSSION_CAT_D', 'DISCUSSION_CAT_D', 'DISCUSSION CATEGORY'),
(3793, 'DISCUSSION_COMMENT_C', 'DISCUSSION_COMMENT_C', 'DISCUSSION COMMENT'),
(3794, 'DISCUSSION_COMMENT_R', 'DISCUSSION_COMMENT_R', 'DISCUSSION COMMENT'),
(3795, 'DISCUSSION_COMMENT_U', 'DISCUSSION_COMMENT_U', 'DISCUSSION COMMENT'),
(3796, 'DISCUSSION_COMMENT_D', 'DISCUSSION_COMMENT_D', 'DISCUSSION COMMENT'),
(3797, 'DISCIPLINE_C', 'DISCIPLINE_C', 'DISCIPLINE'),
(3798, 'DISCIPLINE_R', 'DISCIPLINE_R', 'DISCIPLINE'),
(3799, 'DISCIPLINE_U', 'DISCIPLINE_U', 'DISCIPLINE'),
(3800, 'DISCIPLINE_D', 'DISCIPLINE_D', 'DISCIPLINE'),
(3801, 'FILE_C', 'FILE_C', 'FILE'),
(3802, 'FILE_R', 'FILE_R', 'FILE'),
(3803, 'FILE_U', 'FILE_U', 'FILE'),
(3804, 'FILE_D', 'FILE_D', 'FILE'),
(3805, 'PERMISSION_C', 'PERMISSION_C', 'PERMISSION'),
(3806, 'PERMISSION_R', 'PERMISSION_R', 'PERMISSION'),
(3807, 'PERMISSION_U', 'PERMISSION_U', 'PERMISSION'),
(3808, 'PERMISSION_D', 'PERMISSION_D', 'PERMISSION'),
(3809, 'POSITION_C', 'POSITION_C', 'POSITION'),
(3810, 'POSITION_R', 'POSITION_R', 'POSITION'),
(3811, 'POSITION_U', 'POSITION_U', 'POSITION'),
(3812, 'POSITION_D', 'POSITION_D', 'POSITION'),
(3813, 'PROJECT_C', 'PROJECT_C', 'PROJECT'),
(3814, 'PROJECT_R', 'PROJECT_R', 'PROJECT'),
(3815, 'PROJECT_U', 'PROJECT_U', 'PROJECT'),
(3816, 'PROJECT_D', 'PROJECT_D', 'PROJECT'),
(3817, 'QUESTION_C', 'QUESTION_C', 'QUESTION'),
(3818, 'QUESTION_R', 'QUESTION_R', 'QUESTION'),
(3819, 'QUESTION_U', 'QUESTION_U', 'QUESTION'),
(3820, 'QUESTION_D', 'QUESTION_D', 'QUESTION'),
(3821, 'REGISTRATION_C', 'REGISTRATION_C', 'REGISTRATION'),
(3822, 'REGISTRATION_R', 'REGISTRATION_R', 'REGISTRATION'),
(3823, 'REGISTRATION_U', 'REGISTRATION_U', 'REGISTRATION'),
(3824, 'REGISTRATION_D', 'REGISTRATION_D', 'REGISTRATION'),
(3825, 'RESULT_C', 'RESULT_C', 'RESULT'),
(3826, 'RESULT_R', 'RESULT_R', 'RESULT'),
(3827, 'RESULT_U', 'RESULT_U', 'RESULT'),
(3828, 'RESULT_D', 'RESULT_D', 'RESULT'),
(3829, 'ATTENDANCE_C', 'ATTENDANCE_C', 'ATTENDANCE'),
(3830, 'ATTENDANCE_R', 'ATTENDANCE_R', 'ATTENDANCE'),
(3831, 'ATTENDANCE_U', 'ATTENDANCE_U', 'ATTENDANCE'),
(3832, 'ATTENDANCE_D', 'ATTENDANCE_D', 'ATTENDANCE'),
(3833, 'MARKS_SETUP_C', 'MARKS_SETUP_C', 'MARKS_SETUP'),
(3834, 'MARKS_SETUP_R', 'MARKS_SETUP_R', 'MARKS_SETUP'),
(3835, 'MARKS_SETUP_U', 'MARKS_SETUP_U', 'MARKS_SETUP'),
(3836, 'MARKS_SETUP_D', 'MARKS_SETUP_D', 'MARKS_SETUP'),
(3837, 'GRADE_SETUP_C', 'GRADE_SETUP_C', 'GRADE_SETUP'),
(3838, 'GRADE_SETUP_R', 'GRADE_SETUP_R', 'GRADE_SETUP'),
(3839, 'GRADE_SETUP_U', 'GRADE_SETUP_U', 'GRADE_SETUP'),
(3840, 'GRADE_SETUP_D', 'GRADE_SETUP_D', 'GRADE_SETUP'),
(3841, 'ROLE_C', 'ROLE_C', 'ROLE'),
(3842, 'ROLE_R', 'ROLE_R', 'ROLE'),
(3843, 'ROLE_U', 'ROLE_U', 'ROLE'),
(3844, 'ROLE_D', 'ROLE_D', 'ROLE'),
(3845, 'SCHOOL_C', 'SCHOOL_C', 'SCHOOL'),
(3846, 'SCHOOL_R', 'SCHOOL_R', 'SCHOOL'),
(3847, 'SCHOOL_U', 'SCHOOL_U', 'SCHOOL'),
(3848, 'SCHOOL_D', 'SCHOOL_D', 'SCHOOL'),
(3849, 'SESSION_C', 'SESSION_C', 'SESSION'),
(3850, 'SESSION_R', 'SESSION_R', 'SESSION'),
(3851, 'SESSION_U', 'SESSION_U', 'SESSION'),
(3852, 'SESSION_D', 'SESSION_D', 'SESSION'),
(3853, 'SURVEY_C', 'SURVEY_C', 'SURVEY'),
(3854, 'SURVEY_R', 'SURVEY_R', 'SURVEY'),
(3855, 'SURVEY_U', 'SURVEY_U', 'SURVEY'),
(3856, 'SURVEY_D', 'SURVEY_D', 'SURVEY'),
(3857, 'SURVEY_QUESTION_C', 'SURVEY_QUESTION_C', 'SURVEY QUESTION'),
(3858, 'SURVEY_QUESTION_R', 'SURVEY_QUESTION_R', 'SURVEY QUESTION'),
(3859, 'SURVEY_QUESTION_U', 'SURVEY_QUESTION_U', 'SURVEY QUESTION'),
(3860, 'SURVEY_QUESTION_D', 'SURVEY_QUESTION_D', 'SURVEY QUESTION'),
(3861, 'SURVEY_QUESTION_TYPE_C', 'SURVEY_QUESTION_TYPE_C', 'SURVEY QUESTION TYPE'),
(3862, 'SURVEY_QUESTION_TYPE_R', 'SURVEY_QUESTION_TYPE_R', 'SURVEY QUESTION TYPE'),
(3863, 'SURVEY_QUESTION_TYPE_U', 'SURVEY_QUESTION_TYPE_U', 'SURVEY QUESTION TYPE'),
(3864, 'SURVEY_QUESTION_TYPE_D', 'SURVEY_QUESTION_TYPE_D', 'SURVEY QUESTION TYPE'),
(3865, 'SURVEY_QUESTION_FILLUP_C', 'SURVEY_QUESTION_FILLUP_C', 'SURVEY QUESTION FILLUP'),
(3866, 'SURVEY_QUESTION_FILLUP_R', 'SURVEY_QUESTION_FILLUP_R', 'SURVEY QUESTION FILLUP'),
(3867, 'SURVEY_QUESTION_FILLUP_U', 'SURVEY_QUESTION_FILLUP_U', 'SURVEY QUESTION FILLUP'),
(3868, 'SURVEY_QUESTION_FILLUP_D', 'SURVEY_QUESTION_FILLUP_D', 'SURVEY QUESTION FILLUP'),
(3869, 'TERM_C', 'TERM_C', 'TERM'),
(3870, 'TERM_R', 'TERM_R', 'TERM'),
(3871, 'TERM_U', 'TERM_U', 'TERM'),
(3872, 'TERM_D', 'TERM_D', 'TERM'),
(3873, 'USER_C', 'USER_C', 'USER'),
(3874, 'USER_R', 'USER_R', 'USER'),
(3875, 'USER_U', 'USER_U', 'USER'),
(3876, 'USER_D', 'USER_D', 'USER'),
(3877, 'YEAR_C', 'YEAR_C', 'YEAR'),
(3878, 'YEAR_R', 'YEAR_R', 'YEAR'),
(3879, 'YEAR_U', 'YEAR_U', 'YEAR'),
(3880, 'YEAR_D', 'YEAR_D', 'YEAR'),
(3881, 'VIDEO_C', 'VIDEO_C', 'VIDEO'),
(3882, 'VIDEO_R', 'VIDEO_R', 'VIDEO'),
(3883, 'VIDEO_U', 'VIDEO_U', 'VIDEO'),
(3884, 'VIDEO_D', 'VIDEO_D', 'VIDEO'),
(3885, 'VIDEO_COMMENT_C', 'VIDEO_COMMENT_C', 'VIDEO COMMENT'),
(3886, 'VIDEO_COMMENT_R', 'VIDEO_COMMENT_R', 'VIDEO COMMENT'),
(3887, 'VIDEO_COMMENT_U', 'VIDEO_COMMENT_U', 'VIDEO COMMENT'),
(3888, 'VIDEO_COMMENT_D', 'VIDEO_COMMENT_D', 'VIDEO COMMENT'),
(3889, 'JOB_C', 'JOB_C', 'JOB'),
(3890, 'JOB_R', 'JOB_R', 'JOB'),
(3891, 'JOB_U', 'JOB_U', 'JOB'),
(3892, 'JOB_D', 'JOB_D', 'JOB'),
...
(3679, 'student', 'CLUB_U'),
(3680, 'student', 'CLUB_D'),
(3681, 'student', 'DISCUSSION_C'),
(3682, 'student', 'DISCUSSION_R'),
(3683, 'student', 'DISCUSSION_U'),
(3684, 'student', 'DISCUSSION_D'),
(3685, 'student', 'DISCUSSION_COMMENT_C'),
(3686, 'student', 'DISCUSSION_COMMENT_R'),
(3687, 'student', 'DISCUSSION_COMMENT_U'),
(3688, 'student', 'DISCUSSION_COMMENT_D'),
(3689, 'student', 'PROJECT_R'),
(3690, 'student', 'QUESTION_C'),
(3691, 'student', 'QUESTION_R'),
(3692, 'student', 'QUESTION_U'),
(3693, 'student', 'QUESTION_D'),
(3694, 'student', 'REGISTRATION_R'),
(3695, 'student', 'RESULT_R'),
(3696, 'student', 'THESIS_R'),
(3697, 'student', 'USER_R'),
(3698, 'student', 'VIDEO_C'),
(3699, 'student', 'VIDEO_R'),
(3700, 'student', 'VIDEO_U'),
(3701, 'student', 'VIDEO_D');
