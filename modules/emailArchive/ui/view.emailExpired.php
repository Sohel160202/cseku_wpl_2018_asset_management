...
<div class="col-md-12 myContainer">
    <div class="panel panel-table">
        <table class="table table-bordered table-responsive">
            ...
            $EmailList=$_Paginate->loadPaginatedData($_EmailExpiredBao->getLimitEmail($_Paginate->paginationInitial(),$results_per_page));
            $i=0;
                    ...
                    ?>">
                        ...
                        <td>
                            <input type="date" name="expireAt"
                                   ...
                                   class="form-control" style="display: none" onblur="extendFunction(this);">
                        ...
                        <td>
                            ...
                            <button type="button" class="btn-link span-success"
                                    id="btnExtend<?php echo $i; ?>" onclick="editFunction(this);">
                                extend
                            </button>
                        </td>
...
<!--    Pagination-->
    <?php
    echo $_Paginate->paginate($results_per_page,PageUtil::$EMAIL_EXPIRED,$_EmailExpiredBao->getExpiredEmail());
    ?>
</div>
...
<script>
    ...
    function extendFunction(element) {
        var parent=element.parentNode.parentNode;
        var child=parent.childNodes[13];
        var txt=child.childNodes[1];
        var spn=child.childNodes[3];
